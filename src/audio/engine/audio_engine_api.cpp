...
void AudioEngine::set_metronome_bpm(int bpm) { set_global_bpm(static_cast<float>(bpm)); }
...
float AudioEngine::get_global_bpm() const { return global_bpm_.load(std::memory_order_relaxed); }
