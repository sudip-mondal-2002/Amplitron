...
void AudioEngine::push_param_change(int effect_index, int param_index,
                                    float value) {
...
void AudioEngine::push_mixer_gain_change(int node_id, int pin_index,
                                         float gain) {
...
bool AudioEngine::copy_analyzer_snapshot(float* input_dest, float* output_dest,
  ...
  return analyzer_capture_->copy_analyzer_snapshot(input_dest, output_dest,
                                                   sample_count);
}
