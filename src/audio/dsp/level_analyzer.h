...
/**
 * @brief Utility class to analyze VU levels, RMS smoothing, peak holds, and
 * clip indicators. Moves level computation and smoothing math outside of the UI
 * thread.
 */
class LevelAnalyzer {
 public:
   ...
   */
  void update(float input_rms, float output_rms, bool input_clipped,
