...
class SdlBackend : public IAudioBackend {
 public:
   ...
   * Note: Unlike PortAudioBackend, SDL does not support setting custom input
   * hardware devices dynamically by index under all platforms, but the index is
   * tracked here.
   */
   ...
   * Note: Unlike PortAudioBackend, SDL does not support setting custom output
   * hardware devices dynamically by index under all platforms, but the index is
   * tracked here.
   */
