...
static Amplitron::BackendRegistrar<Amplitron::OboeBackend> g_oboe_registrar(
    "oboe");
#elif defined(__EMSCRIPTEN__) || (defined(__APPLE__) && TARGET_OS_IPHONE)
#include "audio/backend/sdl_backend.h"
static Amplitron::BackendRegistrar<Amplitron::SdlBackend> g_sdl_registrar(
    "sdl");
#else
#include "audio/backend/portaudio_backend.h"
#include "audio/backend/sdl_backend.h"
static Amplitron::BackendRegistrar<Amplitron::PortAudioBackend>
    g_portaudio_registrar("portaudio");
static Amplitron::BackendRegistrar<Amplitron::SdlBackend> g_sdl_registrar(
    "sdl");
#ifdef WITH_JACK
#include "audio/backend/jack_backend.h"
static Amplitron::BackendRegistrar<Amplitron::JackBackend> g_jack_registrar(
    "jack");
#endif
#endif
