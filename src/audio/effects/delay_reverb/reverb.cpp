...
// Right-channel lengths add a prime offset for decorrelation (classic Freeverb
// technique)
static constexpr int STEREO_SPREAD = 23;
static const int COMB_LENGTHS_R[] = {1116 + STEREO_SPREAD, 1188 + STEREO_SPREAD,
                                     1277 + STEREO_SPREAD,
                                     1356 + STEREO_SPREAD};
static const int ALLPASS_LENGTHS_R[] = {556 + STEREO_SPREAD,
                                        441 + STEREO_SPREAD};

Reverb::Reverb() {
  params_ = {
      {"Decay", 0.6f, 0.1f, 0.99f, 0.6f, "",
       "Length of the reverb tail. Higher values simulate larger acoustic "
       "spaces like halls or "
       "caves."},
      {"Damp", 0.4f, 0.0f, 1.0f, 0.4f, "",
       "High-frequency damping. Higher values absorb treble faster, simulating "
       "softer room "
       "materials."},
      {"Level", 0.3f, 0.0f, 1.0f, 0.3f, "",
       "Mix volume of the reverb effect. Controls how wet or distant the "
       "overall sound feels."},
  };
  init_filters();
}
