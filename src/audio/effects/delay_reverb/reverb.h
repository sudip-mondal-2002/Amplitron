...
// Uses a Schroeder-style network: parallel feedback combs
// y_i[n]=x[n]+g_i*y_i[n-d_i] build the decay tail, followed by all-pass filters
// that diffuse echoes while keeping magnitude roughly flat.
