 ...
 *        input frequency, shaped by the input envelope for a warm, organ-like
 * tone. Oct+1: Full-wave rectification (|x|) doubles the fundamental frequency,
...
class Octaver : public Effect {
 ...
 private:
  ...
  float flipflop_ =
      1.0f;  // +1 or -1, toggles on hysteresis-gated positive zero crossings
