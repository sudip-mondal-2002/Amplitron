    ...
    void GuiManager::render_menu_bar()
    {
        if (ImGui::BeginMainMenuBar())
        {
            ...
            if (ImGui::BeginMenu("Audio"))
            {
                ...
                {
                    if (ImGui::MenuItem("Stop Audio", "M"))
                        engine_.stop();
                }
                else
                {
        ...
        if (show_keyboard_shortcuts_)
        {
            ...
            show_keyboard_shortcuts_ = false;
        }
                ...
                ImGuiWindowFlags_None))
        {
            ...
            ImGui::BeginChild("ShortcutsList", ImVec2(0, -40), true);
            ...
            ImGui::Text("Audio");
            ImGui::Separator();
            ImGui::BulletText("M  - Start/Stop Audio");

            ImGui::Spacing();
            ImGui::Text("Application");
            ImGui::Separator();
            ImGui::BulletText("Alt + F4  - Quit");
