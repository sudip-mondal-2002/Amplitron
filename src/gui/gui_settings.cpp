...
namespace Amplitron
{
    ...
    void GuiSettings::render(bool &show)
    {
        ...
        ImGui::TextColored(ImVec4(0.2f, 0.9f, 0.4f, 1.0f), "Audio backend: JACK (compiled)");
#else
        ImGui::TextColored(ImVec4(0.2f, 0.9f, 0.4f, 1.0f), "Audio backend: PortAudio");
#endif
        ...
        ImGui::Spacing();
        ImVec4 load_color = (cpu_load > 0.80f) ? ImVec4(1.0f, 0.2f, 0.2f, 1.0f) : (cpu_load > 0.50f) ? ImVec4(1.0f, 0.8f, 0.2f, 1.0f)
