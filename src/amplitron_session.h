...
/**
 * @brief Unified facade session class that holds and coordinates core
 * subsystems. Satisfies the Facade Pattern and the Dependency Inversion
 * Principle (DIP).
 */
class AmplitronSession {
 public:
  AmplitronSession(
      ...
      std::unique_ptr<IPresetManager> presets =
