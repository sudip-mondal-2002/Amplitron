...
static bool load_raw_preset_sec(const std::string& json,
    ...
    bool ok = PresetManager::load_preset(preset_path, engine, nullptr);
...
TEST(preset_malicious_ir_unc_backslash_rejected) {
    ...
    std::filesystem::create_directories("presets");
    bool loaded = load_raw_preset_sec(malicious_json, "presets/test_malicious_unc.json", engine);
    ASSERT_TRUE(loaded);
...
TEST(preset_malicious_ir_unc_forward_slash_rejected) {
    ...
    std::filesystem::create_directories("presets");
    bool loaded = load_raw_preset_sec(malicious_json, "presets/test_malicious_unc2.json", engine);
    ASSERT_TRUE(loaded);
...
TEST(preset_malicious_ir_traversal_rejected) {
    ...
    std::filesystem::create_directories("presets");
    bool loaded = load_raw_preset_sec(malicious_json, "presets/test_malicious_traversal.json", engine);
    ASSERT_TRUE(loaded);
...
TEST(preset_benign_no_ir_path_loads_cleanly) {
    ...
    std::filesystem::create_directories("presets");
    bool loaded = load_raw_preset_sec(benign_json, "presets/test_benign_sec.json", engine);
    ASSERT_TRUE(loaded);
...
TEST(preset_cabinet_no_ir_path_loads_without_ir) {
    ...
    std::filesystem::create_directories("presets");
    bool loaded = load_raw_preset_sec(json, "presets/test_cab_no_ir_sec.json", engine);
    ASSERT_TRUE(loaded);
