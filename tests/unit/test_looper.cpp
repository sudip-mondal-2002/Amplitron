...
TEST(looper_initial_state_empty) {
  ...
  ASSERT_EQ(static_cast<uint32_t>(looper.state()),
            static_cast<uint32_t>(Looper::State::Empty));
...
TEST(looper_record_then_play_mixes_loop) {
  ...
  ASSERT_EQ(static_cast<uint32_t>(looper.state()),
            static_cast<uint32_t>(Looper::State::Playing));
...
TEST(looper_play_toggle_keeps_loop) {
  ...
  ASSERT_TRUE(looper.has_loop());
  ASSERT_EQ(static_cast<uint32_t>(looper.state()),
            static_cast<uint32_t>(Looper::State::Idle));
