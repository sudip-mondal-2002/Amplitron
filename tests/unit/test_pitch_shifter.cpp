...
// Verified by processing silence: shift=0 ratio=1 means no drift, output stays
// silent
...
// would produce NaN or garbage. Process a full 8192-sample block and confirm no
// NaN.
