...
struct TestAccessor {
    ...
    static void render_footswitch_and_extras(PedalWidget& w, ImDrawList* dl, ImVec2 p0, ImVec2 p1, float pedal_width, float pedal_height, bool is_amp, bool enabled, bool& should_remove, float zoom) {
        w.render_footswitch_and_extras(dl, p0, p1, pedal_width, pedal_height, is_amp, enabled, should_remove, zoom);
    }
...
TEST_F(PresetTest, test_pedal_widget_footswitch_click_interaction) {
    ...
    // From p0 = (10, 10), pedal_width = 190.0f, pedal_height = 360.0f, SWITCH_BOTTOM_OFFSET = 55.0f:
    // switch_y = 10 + 360 - 55 = 315
    // switch_x = 10 + (190 - 50) / 2 = 80
    // sw_center = (80 + 25, 315 + 15) = (105, 330)
    ...
    TestAccessor::render_footswitch_and_extras(widget, dl, p0, p1, 190.0f, 360.0f, false, true, should_remove, 1.0f);
    advance_frame();
