...
TEST_F(PresetTest, test_pedal_widget_knobs_rendering_and_layouts) {
  ...
  TestAccessor::render_knobs(w_od, dl, ImVec2(10, 10), 190.0f, false, false,
                             false, 1.0f);
  advance_frame();
  ...
  TestAccessor::render_knobs(w_amp, dl, ImVec2(10, 10), 190.0f, true, false,
                             false, 1.0f);
  advance_frame();
  ...
  TestAccessor::render_knobs(w_cab, dl, ImVec2(10, 10), 190.0f, false, false,
                             true, 1.0f);
  advance_frame();
  ...
  TestAccessor::render_knobs(w_tuner, dl, ImVec2(10, 10), 190.0f, false, true,
                             false, 1.0f);
  advance_frame();
...
TEST_F(PresetTest, test_pedal_widget_knobs_popup_sweep) {
  ...
  // 3. Test direct drag adjustments (to cover value changed and committed logic
  // in drag mode) Left drag on the knob face
  io.MousePos = ImVec2(62.5f, 102.0f);
  advance_test_frame();
  TestAccessor::render_knobs(w_od, dl, ImVec2(10, 10), 190.0f, false, false,
                             false, 1.0f);
