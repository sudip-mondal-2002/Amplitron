...
TEST_F(PresetTest, gui_snapshots_render_lifecycle) {
  ...
  std::snprintf(gs.status_msg_, sizeof(gs.status_msg_),
                "Mock Snapshot Notification");
  gs.render();
...
TEST_F(PresetTest, gui_snapshots_interactions) {
  ...
  ImVec2 click_pos =
      ImVec2((btn_min.x + btn_max.x) * 0.5f, (btn_min.y + btn_max.y) * 0.5f);
...
TEST_F(PresetTest, gui_snapshots_context_menu_interactions) {
  ...
  ImVec2 menu_click_pos = ImVec2((menu_min.x + menu_max.x) * 0.5f,
  ...
  ImVec2 clear_click_pos = ImVec2((clear_min.x + clear_max.x) * 0.5f,
                                  (clear_min.y + clear_max.y) * 0.5f);
