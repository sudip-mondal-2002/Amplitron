 ...
 * @brief Headless-safe tests for UI components (Theme, EffectColor,
 * GuiSettings).
 *
 * Tests unit-aware parameter formatting, effect color lookups, style
 * applications, and basic settings class rendering using a software ImGui
 * context.
 */
#include <string>
